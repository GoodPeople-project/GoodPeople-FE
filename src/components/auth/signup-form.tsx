    ...
    <div className={style.container}>
      <div className={style.wrapper}>
        ...
        <div className={style.inputWrapper}>
          <label className={style.lable}>이름</label>
          <input className={style.input} placeholder="차두환" />
        </div>
        <div className={style.inputWrapper}>
        ...
        <div className={style.inputWrapper}>
          <label className={style.lable}>비밀번호 확인</label>
          <input className={style.input} type="password" placeholder="password" />
        </div>
        <button className={style.loginButton.default}>회원가입</button>
        <div className={style.divder}>
          <div className={style.line}></div>
          <span className={style.small}>또는</span>
          <div className={style.line}></div>
        </div>
        <button className={style.loginButton.google}>Google 계정으로 회원가입</button>
        <button className={style.loginButton.kakao}>카카오 계정으로 회원가입</button>
        <button className={style.loginButton.naver}>네이버 계정으로 회원가입</button>
